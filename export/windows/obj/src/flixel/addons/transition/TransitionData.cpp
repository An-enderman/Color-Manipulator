...
HXLINE(  60)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXDLIN(  60)			this->direction = this1;
            		}
HXLINE(  62)		{
HXLINE(  62)			Float Value = this->direction->x;
HXDLIN(  62)			Float lowerBound;
HXDLIN(  62)			if ((Value < -1)) {
HXLINE(  62)				lowerBound = ( (Float)(-1) );
            			}
            			else {
HXLINE(  62)				lowerBound = Value;
            			}
HXDLIN(  62)			bool _hx_tmp = (lowerBound > 1);
            		}
HXLINE(  63)		{
HXLINE(  63)			Float Value1 = this->direction->y;
HXDLIN(  63)			Float lowerBound1;
HXDLIN(  63)			if ((Value1 < -1)) {
HXLINE(  63)				lowerBound1 = ( (Float)(-1) );
            			}
            			else {
HXLINE(  63)				lowerBound1 = Value1;
            			}
HXDLIN(  63)			bool _hx_tmp1 = (lowerBound1 > 1);
            		}
