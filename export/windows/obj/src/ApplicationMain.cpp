...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("color manipulator",31,1c,59,ca),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("249",37,1e,26,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("An_Enderman",64,87,b6,57));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("color manipulator",31,1c,59,ca));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("color manipulator",31,1c,59,ca));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("color manipulator",31,1c,59,ca))
