...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("color manipulator", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("color manipulator", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "19";
		app.meta["company"] = "An_Enderman";
		app.meta["file"] = "color manipulator";
		app.meta["name"] = "color manipulator";
