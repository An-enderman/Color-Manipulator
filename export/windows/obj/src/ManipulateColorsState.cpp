...
HXLINE( 115)		this->result_text->set_x(( (Float)(272) ));
HXLINE( 116)		{
HXLINE( 116)			 ::flixel::text::FlxText _this2 = this->result_text;
HXDLIN( 116)			int axes2 = 16;
HXDLIN( 116)			bool _hx_tmp4;
HXDLIN( 116)			if ((axes2 != 1)) {
HXLINE( 116)				_hx_tmp4 = (axes2 == 17);
            			}
            			else {
